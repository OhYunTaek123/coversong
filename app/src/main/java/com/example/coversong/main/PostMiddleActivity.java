...
/*
    private void readPost() {
        mDatabase.child("posts").addChildEventListener(new ValueEventListener() {

            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(dataSnapshot.getValue(WriteInfo.class) != null) {
                    WriteInfo post = dataSnapshot.getValue(WriteInfo.class);
                    startToast("성공");
                } else {
                    startToast("실패");
                }
